    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-10">- Data Master -</h6>
        </li>
        <li class="nav-item">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-10">- Katalog Buku -</h6>
      </li>
      <li class="nav-item">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link {{ request()->is('caribuku') ? 'active' : '' }}" href="{{ route('caribuku') }}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-10">- Transaksi -</h6>
      </li>
      <li class="nav-item">
